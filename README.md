...
| `verify_model.py` | Independent verification suite. 64 checks against closed forms and analytic identities. |
...
`verify_model.py` runs 64 checks. Each states a prediction derived independently — a
