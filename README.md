...
| `verify_model.py` | Independent verification suite. 49 checks against closed forms and analytic identities. |
...
`verify_model.py` runs 49 checks. Each states a prediction derived independently — a
