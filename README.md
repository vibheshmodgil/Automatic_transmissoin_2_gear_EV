...
| `verify_model.py` | Independent verification suite. 61 checks against closed forms and analytic identities. |
...
`verify_model.py` runs 61 checks. Each states a prediction derived independently — a
