...
| `verify_model.py` | Independent verification suite. 62 checks against closed forms and analytic identities. |
...
`verify_model.py` runs 62 checks. Each states a prediction derived independently — a
