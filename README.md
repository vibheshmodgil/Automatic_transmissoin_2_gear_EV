...
| `verify_model.py` | Independent verification suite. 67 checks against closed forms and analytic identities. |
...
`verify_model.py` runs 67 checks. Each states a prediction derived independently — a
