...
| `verify_model.py` | Independent verification suite. 44 checks against closed forms and analytic identities. |
...
`verify_model.py` runs 44 checks. Each states a prediction derived independently — a
